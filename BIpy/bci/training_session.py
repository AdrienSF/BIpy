...
from BIpy.data_processing import get_windows
...
class TrainingSession():
    ...
    def collect(logger):
        ...
        # ask to start
        self.text_stim.text = 'Press any key to start.'
        self.text_stim.draw()
        self.window.flip()
        event.waitKeys()
        self.window.flip()
        ...
        # ask for label
        self.text_stim.text = 'Which side were you imagining? press 1 for left and 0 for right'
        self.text_stim.draw()
        self.window.flip()
